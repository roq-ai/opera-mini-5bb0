  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Unleash the power of blockchain with Opera mini, your reliable and secure crypto wallet that turns digital assets management into a smooth journey."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1661868811655-8377fd565661?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjcnlwdG8lMjB3YWxsZXR8ZW58MHx8fHwxNjk1Mjk3NTI2fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@stibits?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Stibits`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unleash the power of blockchain with Opera mini, your reliable and secure crypto wallet that turns digital assets management into a smooth journey.`}
            </Text>
            <Box
