...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Task completed.update': { roles: ['owner', 'team-member'], key: 'Task', tenantPath: [], userPath: [] },
  'Project started.create': { roles: ['owner', 'team-member'], key: 'Project', tenantPath: [], userPath: [] },
  'Issue resolved.update': { roles: ['owner', 'team-member'], key: 'Issue', tenantPath: [], userPath: [] },
};
